...
Vybral som si jeden z vasich eshopov a vyrobil som script, ktory renderuje vsetky upravy z tohoto bodu. Uobil som to stylom, akym so zvyknuty, myslim ze by sa vam to mohlo pacit. Bolo to super, po dlhej dobe vanilla js, bavilo ma to. Kod sa da sazmorejme rozdelit do tematickych blokov, ja to mam v jednom.

---

## 🛠️ Implementácia

Cely kod by sa mal spustat v momente kedy je DOM plne pripraveny. 
